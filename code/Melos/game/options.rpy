...
init -1 python hide:
    ...
    config.main_menu_music = "music/JAyFS_-_Quiet_village.ogg"
...
python early:
    config.save_directory = "Melos-1444256243"
...
init python:
    ...
    build.directory_name = "Melos-0.4"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Melos"
