...
label sick:
    ...
    "I approach calmly, and ask softly if she is alright. She nods, still staring into nothingness. I ask again and she gives me the same soulless response, then adds."

    antiope "You can go. Everything's alright."

    "This only manages to increase my worries. Antiope is especially not well. She looks like she could break at any moment, and is only pretending to be fine because of her impossible stubbornness. I fear I will find her into small pieces tomorrow if I leave her like this, shivering in the cold when she can barely stand on her two legs."
...
label fake:
    ...
    "Antiope doesn't really care about such technicalities however. She straightens her back to listen, and comments, with a mischievous smile."

    antiope "Ho, you have the hots for someone? And who is the lucky bastard?"
...
label shake:
    "I get closer and put my hands upon her cheeks, forcing her to look at me. A gentle, soft move to bring her back to reality and give her a little of my own warmth."
...
label misconception:
    ...
    antiope "And now, are you ready to talk?"
    ...
    ambrosia "The point I'm trying to get is that our relationship evolved. We started as strangers under the same roof, and we slowly but surely became the best of friends."

    "Antiope crosses her arm and appears to think."

    antiope "Quite a long introduction for an obvious statement. But I guess you're preparing for what's next. How our relationship should evolve from now on. I have been thinking about it myself."
    ...
    "My mind is overloading. I prepared myself for anything but that."
